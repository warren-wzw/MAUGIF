...
BATCH_SIZE=8
EPOCH=100
image_path_rgb = f'/home/BlueDisk/Dataset/FusionDataset/Done/MedicalImage/total/img/'
image_path_ir = f'/home/BlueDisk/Dataset/FusionDataset/Done/MedicalImage/total/mri/'
...
def main():
    ...
    for epoch_index in range(EPOCH):
        ...
        for step, (vis, ir) in enumerate(train_iterator):
            ...
            loss3 = 1*torch.norm(vis_en-ir,2) + 2*torch.norm(vis_en-Y_vis,2)
